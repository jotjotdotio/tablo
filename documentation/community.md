...
In general, the __tablo__ project strives to promote an
...
people outside the community, their actions reflect on the __tablo__ project
in general.
We respect that everyone has a life outside of this community, but when acting
as a representative of __tablo__, these guidelines should still apply.
...
shared goal of improving __tablo__.


# Diversity

__We welcome participation by everyone.__
We welcome and support people of every gender identity or expression, race, 
ethnicity, sexual orientation, nationality, religion, age, ability, culture,
political stance, skill level, occupation, and background.
...
__tablo__ strives to support as many humans as possible.
Whether someone deals with limited mobility, low vision, or colorblindness
shouldn't prevent them from using __tablo__ or projects that use it.
...
Disagreements, both social and technical, happen all the time and __tablo__
is no exception.
It is important that we resolve disagreements and differing views constructively.
Remember that we're different.
The strength of __tablo__ comes from its varied community, people from a
...
Guidelines specific to particular tasks (like coding guidelines or usability
...
Being asked to leave the community does not oblige the __tablo__ team to
